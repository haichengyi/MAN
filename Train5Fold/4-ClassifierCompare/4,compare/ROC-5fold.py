...
# 2
PAndRAttribute = []
ReadMyCsv(PAndRAttribute, 'FprAndTprNB.csv')
P = []
R = []
counter = 0
...
plt.plot(P, R, color='green',
         label=r'NB (AUC = %0.4f)' % (roc_auc),linestyle='--',
         lw=2, alpha=1)

# 3
PAndRAttribute = []
ReadMyCsv(PAndRAttribute, 'FprAndTprAdaboost.csv')
P = []
R = []
counter = 0
while counter < len(PAndRAttribute):
...
plt.plot(P, R, color='purple',
         label=r'Adaboost (AUC = %0.4f)' % (roc_auc),linestyle='-.',
         lw=2, alpha=1)

# 4
PAndRAttribute = []
ReadMyCsv(PAndRAttribute, 'FprAndTprLR.csv')
P = []
R = []
counter = 0
while counter < len(PAndRAttribute):
...
plt.plot(P, R, color='orange',
         label=r'LR (AUC = %0.4f)' % (roc_auc),linestyle='-',
         lw=2, alpha=1)

# 5
PAndRAttribute = []
ReadMyCsv(PAndRAttribute, 'FprAndTprXgboost.csv')
P = []
R = []
counter = 0
while counter < len(PAndRAttribute):
...
plt.plot(P, R, color='deepskyblue',
         label=r'XGBoost (AUC = %0.4f)' % (roc_auc),linestyle=':',
         lw=2, alpha=1)

# 1
PAndRAttribute = []
ReadMyCsv(PAndRAttribute, 'FprAndTprAttributeManner.csv')
P = []
R = []
counter = 0
while counter < len(PAndRAttribute):
...
plt.plot(P, R, color='crimson',
         label=r'Proposed Method (AUC = %0.4f)' % (roc_auc),linestyle='-',
         lw=2, alpha=1)
