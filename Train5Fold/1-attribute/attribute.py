...
while counter < 5:
    AllNodeFeatureNum = []
    AllNodeFeatureNumName = 'AllNodeAttributeNum.csv'
    ...
    model1 = RandomForestClassifier() #CatBoostClassifier()
...
StorFile(MyNew, '五折的表-attribute.csv')
...
# 保存图片
# plt.savefig('5fold-attribute.svg')
# plt.savefig('5fold-attribute.tif')
plt.show()