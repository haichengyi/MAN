...
def MyNodeEdgeAttributeGenerate():
    ...
    for association in ["LncDiseaseMergeAssociation", "LncMLncRNA2TargetAssociation",
                        ...
                        "MiProteinMergeAssociation", # "MiDiseaseCuiAssociation",
                        "MiMNMiTarbaseAssociation", "MiDrugSM2Association",
        ...
        association_temp = []
        ReadMyCsv(association_temp, association + ".csv")
    ...
    for Attribute in ["AllCircKmer", "AllDiseaseFeatureDAGLocal", "AllDrugFeature", "AllLncKmer",
        ...
        attribute_temp = []
        ReadMyCsv(attribute_temp, str(Attribute) + ".csv")
