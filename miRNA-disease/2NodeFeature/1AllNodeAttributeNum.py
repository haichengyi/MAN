...
FinalLncFeature = []
ReadMyCsv(FinalLncFeature, 'AllMiKmer.csv')         # 部分由Gaussian部分生成

FinalMiFeature = []
ReadMyCsv(FinalMiFeature, 'AllDiseaseFeatureDAGLocal.csv')
...
StorFile(FinalLncFeatureNum, 'FinalMiFeatureNum.csv')
