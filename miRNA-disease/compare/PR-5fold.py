...
# 1
PAndRAttribute = []
ReadMyCsv(PAndRAttribute, 'PAndRAttribute.csv')
P = []
R = []
counter = 0
...
plt.plot(P, R, color='green',
         label=r'Attribute(AUPR=%0.4f)' % (0.8852),linestyle=':', marker=',',
         lw=2, alpha=1)
# MyEnlarge(0, 0.7, 0.25, 0.25, 0.5, 0, 2, P, R, 2, color='black')

# 2
PAndRAttribute = []
ReadMyCsv(PAndRAttribute, 'PAndRManner.csv')
P = []
R = []
counter = 0
while counter < len(PAndRAttribute):
...
plt.plot(P, R, color='red',
         label=r'Embedding(AUPR=%0.4f)' % (0.8964),linestyle='-.',
         lw=2, alpha=1)
...
plt.plot(P, R, color='navy',
         label=r'Attribute+embedding(AUPR=%0.4f)' % (0.8971),linestyle='-',
         lw=2, alpha=1)
