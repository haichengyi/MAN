...
# ReadMyCsv(test_attribute_manner, 'test_attribute_manner.csv')
#
# miRNA_name = []
# ReadMyCsv(miRNA_name,'breast neoplams.csv')
# miRNA_name = [[x[0] for x in miRNA_name]]
# #StorFile(miRNA_name,'miRNA_name.csv')
# miRNA_name = np.transpose(miRNA_name).tolist()

train_attribute_manner = []
ReadMyCsv(train_attribute_manner, 'train_attribute_manner.csv')
...
while counter < 1:
    ...
    TrainLabel = []
    TrainFeature = []
    TrainFeature = train_attribute_manner
