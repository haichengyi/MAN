...
ReadMyCsv(test_attribute_manner, 'colontest_attribute_manner.csv')

miRNA_name = []
ReadMyCsv(miRNA_name,'colon neoplams.csv')
miRNA_name = [[x[0] for x in miRNA_name]]
#StorFile(miRNA_name,'miRNA_name.csv')
miRNA_name = np.transpose(miRNA_name).tolist()
...
while counter < 1:
    ...
    #TestLabel = []
    TestFeature = []
    TestFeature = test_attribute_manner
    ...
    # StorFile(TestFeature, 'TestFeature.csv')
    ...
    # StorFile(y_score1,'y_score1.csv')
    #RealAndPredictionProb = MyRealAndPredictionProb(miRNA_name,y_score1)
    #RealAndPredictionProb = []
    RealAndPredictionProb = np.hstack((miRNA_name,y_score1))
    StorFile(RealAndPredictionProb, 'colon neoplamsProb.csv')
