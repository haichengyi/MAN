...
testbreastNum = []
ReadMyCsv(testbreastNum, 'colonNum.csv')
...
while counterP < 1:
    ...
    # StorFile(test_1, 'testtest_1.csv')
    ...
    while counter_1 < len(testbreastNum):
        ...
        counter_1 = counter_1 + 1
        print(counter_1)
    # StorFile(test_2, 'testtest_2.csv')
    ...
    # StorFile(test_3, 'testtest_3.csv')
    ...
    # StorFile(test_4, 'testtest_4.csv')
    ...
    StorFile(test_attribute_manner, 'colontest_attribute_manner.csv')
    ...
    # StorFile(AllNodeMannerNum, 'esophagealALL_attribute+manner.csv')
