...
AllEdge = []
ReadMyCsv(AllEdge, "MiDiseaseCuiAssociation.csv")
...
StorFile(AllEdgeNum, 'MiDiseaseCuiAssociation.csv')

#生成AllDiseaseNum，AllMiNum

AllDiseaseNum = Tool.GenerateAllDrug(AllEdgeNum)
AllMiNum = Tool.GenerateAllDisease(AllEdgeNum)


Tool.StorFile(AllDiseaseNum, 'AllDiseaseNum.csv')
